...
*   **Attendance** (`/attendance`): single-table design with composite `sessionKey`; teacher scoping via `TeacherAssignment.targetKey`; manual marking + biometric ingest endpoint.
