    ...
    <div className="p-6 md:p-8 space-y-8 select-none font-sans antialiased text-slate-800 animate-fade-in bg-slate-50">
      ...
      <section className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {stats?.ops.uptimePct != null ? (
            <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
              <Activity className={`w-5 h-5 ${stats.ops.uptimePct >= 99 ? 'text-green-500' : 'text-amber-500'}`} />
              <div>
                <div className="text-[10px] font-bold text-slate-400 uppercase">Uptime (7d)</div>
                <div className="text-sm font-bold text-slate-900">{stats.ops.uptimePct}%</div>
              </div>
            </div>
          ) : (
            <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
