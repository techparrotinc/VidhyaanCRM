...
export default function ForgotPinPage() {
  ...
  // --- STEP 2: OTP VERIFICATION (entry UI lives in the shared <OtpInput />) ---
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <OtpInput
                      ...
                      boxClassName="w-12 h-12 text-center text-xl font-extrabold bg-slate-50 border-2 border-slate-200 rounded-xl focus:outline-none focus:border-[#1565D8] focus:ring-4 focus:ring-blue-50/50 transition-all text-slate-800 disabled:opacity-50 font-sans"
                    />
                  </div>
