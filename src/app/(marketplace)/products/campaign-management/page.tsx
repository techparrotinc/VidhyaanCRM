...
export const metadata: Metadata = {
  title: 'Admissions Campaign Management (WhatsApp & Email) | Vidhyaan',
  description: 'Engage parent inquiries through instant automated WhatsApp and Email broadcast campaigns.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Reach parents instantly where they are. Launch targeted broadcast campaigns via WhatsApp and Email to share updates, events, and admission announcements. Personalize messages to build stronger trust and increase admissions.
      </p>
