  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Empower parents to make confident, informed decisions. Our side-by-side comparison engine highlights differences in academic performance, student-teacher ratios, fee tiers, reviews, and amenities across multiple institutions instantly.
      </p>
