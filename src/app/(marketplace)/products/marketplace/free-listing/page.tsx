  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl md:text-4xl font-black tracking-tight text-slate-900 leading-tight">
        Free School & Learning Center Listing
      </h1>
      
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Get your institution in front of thousands of parents searching for the best education. Create a rich, comprehensive school profile showcasing your facilities, curriculum, admission criteria, and fee structure entirely for free.
      </p>
