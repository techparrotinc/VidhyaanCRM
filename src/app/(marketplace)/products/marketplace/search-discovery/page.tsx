...
export const metadata: Metadata = {
  alternates: { canonical: 'https://vidhyaan.com/products/marketplace/search-discovery' },
  title: 'Parent Search & Discovery | Vidhyaan',
  description: 'Help parents find, filter, and discover your school based on location, curriculum, and reviews.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Allow parents to discover your school effortlessly using advanced filters. Parents can filter by location, distance, ratings, curriculum, and board to find the perfect fit, ensuring your profile receives high-intent traffic.
      </p>
