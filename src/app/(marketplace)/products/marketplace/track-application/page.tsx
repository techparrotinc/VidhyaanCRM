...
export const metadata: Metadata = {
  title: 'Track Your Admission Application | Vidhyaan',
  description: 'Allows parents to track the real-time status of their school admission applications.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Give parents peace of mind with real-time application updates. Our transparent tracking portal shows parents precisely where their child's application stands—from initial submission to document review and final enrollment.
      </p>
