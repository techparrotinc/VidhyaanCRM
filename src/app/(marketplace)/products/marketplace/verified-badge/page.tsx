  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Stand out as a verified, trusted institution. The Vidhyaan Verified Profile Badge signals authenticity, validated metrics, and active responsiveness, helping you win parent confidence and attract higher-quality enquiries.
      </p>
