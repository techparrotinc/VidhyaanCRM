...
export const metadata: Metadata = {
  title: 'Automated Notifications & Alerts | Vidhyaan',
  description: 'Keep parents and staff informed with automated SMS, Email, and WhatsApp alerts.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Never miss an update. Send instant multi-channel alerts to parents and teachers via SMS, Email, and WhatsApp. Automate critical fee payment reminders, attendance updates, event announcements, and emergency notifications.
      </p>
