...
export const metadata: Metadata = {
  title: 'Interactive Parent Portal | Vidhyaan',
  description: 'Provide a dedicated portal for parents to view student progress, pay fees, and communicate.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Bridge the gap between home and school. Our comprehensive Parent Portal lets guardians view academic progress, track live student attendance, view invoices, download digital reports, and pay school fees instantly online.
      </p>
