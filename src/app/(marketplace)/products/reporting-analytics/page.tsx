...
export const metadata: Metadata = {
  title: 'School Reporting & Admission Analytics | Vidhyaan',
  description: 'Gain deeper insights into student retention, conversion rates, and revenue trends.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Make data-driven decisions with rich dashboards and reports. Monitor inquiry conversion rates, tracking channels, and school performance metrics in real time. Gain insights into fee collections and student attrition.
      </p>
