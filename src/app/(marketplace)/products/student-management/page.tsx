...
export const metadata: Metadata = {
  title: 'Student Information & Management System | Vidhyaan',
  description: 'Manage student profiles, attendance, classes, and academic records in one central database.',
}
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-xl text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg mx-auto">
        Maintain complete digital records for every student enrolled. Track attendance, manage class assignments, and store academic details in a secure, unified database. Save hours of administrative work and foster parent transparency.
      </p>
