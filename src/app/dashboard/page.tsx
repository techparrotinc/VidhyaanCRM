            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 flex flex-col hover:shadow-md transition-shadow duration-300">
              <div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="bg-amber-100 text-amber-700 text-[10px] font-semibold px-2 py-0.5 rounded-full flex items-center gap-0.5 shrink-0">
                    <Crown className="w-2.5 h-2.5 fill-amber-500 text-amber-500" strokeWidth={1.5} />
                    <span>Premium</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div className="flex flex-col">
                    <span className="text-xl font-extrabold text-slate-800 leading-none" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  ...
                  <div className="flex flex-col border-x border-slate-100 px-3">
                    <span className="text-xl font-extrabold text-red-600 leading-none" style={{ fontFamily: "'Poppins', sans-serif" }}>
                      ₹{feeData.overdue.toLocaleString('en-IN')}
                    </span>
                    <span className="text-[10px] font-semibold text-red-500 uppercase tracking-wider mt-1.5 flex items-center gap-0.5">
                      Overdue <TriangleAlert className="w-3 h-3 text-red-500 shrink-0" strokeWidth={2} />
                    </span>
                  </div>
                ...
                <div className="flex items-center justify-between px-1 text-xs font-semibold text-slate-600">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Paid: {feeData.students.paidOnTime}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-red-500 shrink-0" />
                    <span>Overdue: {feeData.students.overdue}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-amber-400 shrink-0" />
                    <span>Due: {feeData.students.upcomingDues}</span>
                  </div>
                </div>

                {/* nudge section */}
                {feeData.students.overdue > 0 && (
                  <div className="mt-4 bg-red-50 border border-red-100 rounded-lg px-4 py-2.5 flex justify-between items-center text-xs">
                    <div className="flex items-center text-red-800 font-semibold min-w-0">
                      <TriangleAlert className="w-3.5 h-3.5 text-red-500 shrink-0 mr-2" strokeWidth={1.5} />
                      <span className="truncate">Send fee reminders to {feeData.students.overdue} students</span>
                    </div>
                    <span className="font-bold text-red-700 cursor-pointer shrink-0 hover:underline">
                      Send Now →
                    </span>
                  </div>
                )}
              ...
              <div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Plus className="w-4 h-4 text-slate-400 cursor-pointer hover:text-[#1565D8] transition" strokeWidth={1.5} />
                  </div>
                </div>
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    { date: "JUN 05", title: "World Environment Day", type: "Holiday", color: "bg-green-50 text-green-600", icon: CalendarOff }
                  ].slice(0, 4).map((ev, idx) => {
                    return (
                      <div key={idx} className="flex items-start gap-4 py-3 border-b border-slate-50 last:border-0">
                        <div className="bg-slate-800 text-white rounded-lg w-12 h-12 flex flex-col items-center justify-center flex-shrink-0">
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 flex flex-col hover:shadow-md transition-shadow duration-300">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {/* Action 1 */}
                  <button className="flex items-center gap-2 px-3 py-3 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                    <Plus className="w-4 h-4 text-slate-500 shrink-0" strokeWidth={1.5} />
                    <span>Add Lead</span>
                  </button>

                  {/* Action 2 */}
                  <button className="flex items-center gap-2 px-3 py-3 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                    <UserPlus className="w-4 h-4 text-slate-500 shrink-0" strokeWidth={1.5} />
                    <span>
                  ...
                  {/* Action 3 (Hide for learning center) */}
                  {institutionConfig.type !== 'learning_center' && (
                    <button className="flex items-center gap-2 px-3 py-3 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                      <UserCheck className="w-4 h-4 text-slate-500 shrink-0" strokeWidth={1.5} />
                  ...
                  {/* Action 4 */}
                  <button className="flex items-center gap-2 px-3 py-3 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                    <Receipt className="w-4 h-4 text-slate-500 shrink-0" strokeWidth={1.5} />
                    <span>New Invoice</span>
                  </button>

                  {/* Action 5: Premium Campaign */}
                  <button className="flex items-center gap-2 px-3 py-3 rounded-lg bg-amber-50 border border-amber-200 text-xs font-semibold text-amber-800 hover:bg-amber-100 hover:border-amber-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                    <Megaphone className="w-4 h-4 text-amber-600 shrink-0" strokeWidth={1.5} />
                    <span>Campaign 👑</span>
                  </button>

                  {/* Action 6 */}
                  <button className="flex items-center gap-2 px-3 py-3 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition cursor-pointer w-full text-left whitespace-normal leading-tight">
                    <Globe className="w-4 h-4 text-slate-500 shrink-0" strokeWidth={1.5} />
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  ...
                  <div className="space-y-1">
                    {[
                      { initial: "S", desc: "Lead added: Saran Kumar", time: "2h ago" },
                      { initial: "P", desc: "Admission: AT-00020 created", time: "5h ago" },
                      { initial: "V", desc: "Invoice sent to Mani Raj", time: "1d ago" }
                    ].map((act, idx) => (
                      <div key={idx} className="flex items-center gap-3 py-2 border-b border-slate-50 last:border-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-medium text-slate-700 truncate">{act.desc}</p>
