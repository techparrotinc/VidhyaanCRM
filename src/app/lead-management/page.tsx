  ...
  return (
    <>
      ...
      <div className="flex-1 md:pl-16 lg:pl-64 pt-14 md:pt-0 flex flex-col min-w-0">
        ...
        <main className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-5 lg:space-y-6 max-w-7xl mx-auto w-full bg-slate-100 min-h-[calc(100vh-4rem)]">
          ...
          {activeView === 'list' && (
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              {/* TABLE HEADER */}
              <div className="bg-slate-50 border-b border-slate-200 hidden md:flex items-center px-5 py-3 gap-4">
                ...
                <div className="flex-1 min-w-[200px] text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Lead Name
                </div>
                <div className="hidden md:flex w-32 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  {applyingForLabel[institutionType as keyof typeof applyingForLabel]}
                </div>
                <div className="hidden md:flex w-28 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Source
                </div>
                <div className="hidden lg:flex w-24 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Connect
                </div>
                <div className="hidden lg:flex w-36 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Counsellor
                </div>
                <div className="hidden xl:flex w-28 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Date
                </div>
                <div className="w-28 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600">
                  Status
                </div>
                <div className="w-12 flex-shrink-0 text-[11px] font-bold uppercase tracking-wider text-slate-600 text-center">
                  Action
                </div>
              </div>
