...
export function LanguageTagInput({
  ...
  return (
    <div className="relative" ref={containerRef}>
      <div
        className="border border-slate-200 rounded-lg min-h-[42px] px-3 py-2 flex flex-wrap gap-1.5 items-center cursor-text focus-within:ring-2 focus-within:ring-blue-500 bg-white"
        onClick={() => {
      ...
      >
        {selectedOptions.map((opt) => (
          ...
          >
            ...
            <button
              type="button"
              className="ml-0.5 text-blue-400 hover:text-blue-700 cursor-pointer font-bold text-sm"
              onClick={(e) => {
                e.stopPropagation()
