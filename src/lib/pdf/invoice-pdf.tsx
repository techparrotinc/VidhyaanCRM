...
/** Render the invoice PDF to a buffer — shared by CRM and parent routes. */
export async function renderInvoicePdf(invoice: unknown, organization: unknown): Promise<Buffer> {
  // @react-pdf/renderer types toBuffer as ReadableStream; at runtime in Node
  // it resolves to a Buffer (same cast the original CRM route relied on).
  return pdf(
